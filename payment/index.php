        ...
        <div class="content">
          ...
          <div class="table-container">
            <div class="button-wrapper">
              <a href="./create.php" class="btn" id="create-link">
                    <i class="fa-solid fa-pen"></i> Add payment</a>
                ...
                <tbody>
                  <?php foreach ($all as $row): ?>
                    <tr>
                      ...
                      <td>
                        <a href="./edit.php?payment_id=<?= $row['PaymentID'] ?>" title="Edit payment" class="edit-link" data-id="<?= $row['PaymentID'] ?>">
                          <i class="fa-solid fa-pen"></i></a>
                        <a href="./delete.php?payment_id=<?= $row['PaymentID'] ?>" title="Delete payment" class="delete-link" data-id="<?= $row['PaymentID'] ?>">
          ...
          <dialog id="edit-dialog">
            <div class="dialog-header">
              <div class="dialog-title">Edit 1 payment</div>
          ...
          <dialog id="create-dialog">
            <div class="dialog-header">
              <div class="dialog-title">Add payment</div>
              <button class="close">&times;</button>
            </div>
          ...
          <dialog id="delete-dialog">
            <div class="dialog-header">
              <div class="dialog-title">Delete payment</div>
              <button class="close">&times;</button>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      document.querySelectorAll('.edit-link').forEach(link => {
        link.addEventListener('click', function(e) {
          ...
          openDialog(editDialog, editBody, `edit.php?payment_id=${id}`);
        });
      });
      ...
      document.querySelectorAll('.delete-link').forEach(link => {
        link.addEventListener('click', function(e) {
          e.preventDefault();
          const id = this.dataset.id;
          openDialog(deleteDialog, deleteBody, `delete.php?payment_id=${id}`);
        });
      });
