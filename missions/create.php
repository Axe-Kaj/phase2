...
<body>
    ...
    <form action="./create.php" method="POST">
        ...
        <input type="number" id="mission_id" name="mission_id"
               value="<?= htmlspecialchars($_POST['mission_id'] ?? '') ?>" required><br><br>

        <label for="start_datetime">Start DateTime:</label>
        <input type="datetime-local" id="start_datetime" name="start_datetime"
               value="<?= htmlspecialchars($_POST['start_datetime'] ?? '') ?>" required><br><br>

        <label for="end_datetime">End DateTime:</label>
        <input type="datetime-local" id="end_datetime" name="end_datetime"
               value="<?= htmlspecialchars($_POST['end_datetime'] ?? '') ?>" required><br><br>

        <label for="rendezvous_address">Rendezvous Address:</label>
        <input type="text" id="rendezvous_address" name="rendezvous_address"
               value="<?= htmlspecialchars($_POST['rendezvous_address'] ?? '') ?>" required><br><br>
